...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div>
			<div class="main-page">
				<h3 class="title1" style="text-align: center;">Forum</h3>
  ...
  <table class="table table-bordered">
    ...
    <tbody id="myTable">
      <tr>
        ...
        <td><a><button type="button" class="btn btn-primary btn-circle" data-toggle="tooltip" title="view"><i class="fa fa-eye"> </i></button> </a></td>
      </tr>
      <tr>
        <td>Mary</td>
        <td>Moe</td>
